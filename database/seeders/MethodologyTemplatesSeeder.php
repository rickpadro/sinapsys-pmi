    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                'slug'        => 'ef-ai360',
                'name'        => 'EF-Ai360',
                'description' => 'Estructurar Futuro: 10 sprints + Sprint 0 discovery + 3 tracks paralelos continuos.',
                'default_view' => 'timeline',
                'default_sections' => [
                    ['name' => 'Sprint 0 · Setup',          'order' => 0,   'type' => 'discovery', 'status' => 'planned'],
                    ['name' => 'Sprint 1',                   'order' => 1,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 2',                   'order' => 2,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 3',                   'order' => 3,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 4',                   'order' => 4,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 5',                   'order' => 5,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 6',                   'order' => 6,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 7',                   'order' => 7,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 8',                   'order' => 8,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Sprint 9',                   'order' => 9,   'type' => 'sprint',    'status' => 'planned'],
                    ['name' => 'Track · Infra & DevOps',     'order' => 100, 'type' => 'continuous','status' => 'active'],
                    ['name' => 'Track · Observabilidad',     'order' => 101, 'type' => 'continuous','status' => 'active'],
                    ['name' => 'Track · PAC DIAN',           'order' => 102, 'type' => 'continuous','status' => 'active'],
                ],
                'default_fields' => [
                    ['name' => 'Story Points', 'slug' => 'story_points', 'field_type' => 'number', 'applies_to' => 'task'],
                    ['name' => 'Sprint Goal',  'slug' => 'sprint_goal',  'field_type' => 'text',   'applies_to' => 'section'],
                    ['name' => 'Tipo',         'slug' => 'item_type',    'field_type' => 'select',  'applies_to' => 'task',
                     'options' => ['User Story', 'Bug', 'Task', 'Spike', 'Epic']],
                    ['name' => 'Track',        'slug' => 'track',        'field_type' => 'select',  'applies_to' => 'task',
                     'options' => ['Infra & DevOps', 'Observabilidad', 'PAC DIAN', 'Core']],
                ],
                'default_roles' => [
                    ['name' => 'Scrum Master',  'permissions' => ['can_edit' => true,  'can_invite' => true,  'can_delete' => false]],
                    ['name' => 'Product Owner', 'permissions' => ['can_edit' => true,  'can_invite' => true,  'can_delete' => false]],
                    ['name' => 'Dev Team',      'permissions' => ['can_edit' => false, 'can_invite' => false, 'can_delete' => false]],
                    ['name' => 'Tech Lead',     'permissions' => ['can_edit' => true,  'can_invite' => false, 'can_delete' => false]],
                ],
            ],
            [
                'slug'        => 'kanban',
